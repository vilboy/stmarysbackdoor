...
class log {
    ...
    public function logger($filename) {
        ...
        include('config.php');
            ...
            $sql = "INSERT INTO log (date,ip,u_agent,ub,uos,u_refer,req_uri)
                VALUES ('$this->timestamp', '$this->ip', '$this->u_agent','$this->ub','$this->uos','$this->u_refer','$this->req_uri')";
